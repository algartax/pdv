// agenda-servicos-modal.js - Modal Principal de Agendamento
// ==========================================================
...
class AgendaModals {
    ...
    async generateTimeSlots(callback = null) {
        ...
        const selectedProfessional = this.elements.professionalSelect.value;
        ...
        for (let totalMinutes = startTotalMinutes; totalMinutes < endTotalMinutes; totalMinutes += interval) {
            ...
            const isOccupied = await this.isTimeSlotOccupied(selectedDate, timeString, selectedProfessional);
    ...
    async isTimeSlotOccupied(date, time, professionalId) {
        if (!date || !professionalId) return false;
