...
function changeYear(direction) {
    ...
    updateYearDisplay();
    // Apenas atualiza o gráfico, não recarrega os dados dos clientes
    loadChartData();
}
...
async function loadCashbackFromDB() {
    ...
    // Carrega TODOS os dados de cashback, não filtra por ano
    // O filtro por ano será aplicado apenas no gráfico
...
function calcularEstatisticas() {
    state.estatisticas = {
        ...
        geradoMesAtual: state.clientes.reduce((acc, c) => acc + c.totalGerado, 0), // Total gerado desde sempre
