...
class ComprovanteModal {
    ...
    getModalHTML() {
        ...
        return `
            <div class="header header-content" style="background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); color: white; padding: 2rem; text-align: center; border-bottom: 0.0625rem solid #e5e7eb;">
                <h1 style="font-size: 1.75rem; margin: 0 0 0.5rem 0; font-weight: 700; letter-spacing: -0.025em;">Comprovante de Venda</h1>
                <p style="font-size: 1rem; opacity: 0.8; margin: 0; font-weight: 400;">Escolha como deseja processar seu comprovante</p>
            </div>
